...
class Agent(object):
  ...
  def init_network(self):
    ...
    model.add(tf.keras.layers.Conv2D(filters=16, kernel_size=1, activation='sigmoid', name="block1_conv1"))
    model.add(tf.keras.layers.Conv2D(filters=32, kernel_size=1, activation='sigmoid', name="block1_conv2"))
